---
title: "200410 MS redo"
output: html_document
---
#This code was rebuilt using Amy's GitHub code
...
```{r}
setwd("C:/Users/David Vu/Documents/Work/REDCap Data/LaBeaud R01")
#library(redcapAPI)
#library(REDCapR)
...
#R01_lab_results <- redcap_read(redcap_uri  = REDcap.URL, token= Redcap.token, batch_size = 300, continue_on_error = TRUE)

#R01<-redcap_read_oneshot(redcap_uri= REDcap.URL, token=Redcap.token, raw_or_label = "raw", raw_or_label_headers = "raw", guess_type = FALSE, guess_max = 1000L, verbose = TRUE, config_options = NULL)$data
load("2020-04-07_R01.rda") #most recent working file, 84922 obs 1597 variables
R01backup<-R01

currentDate <- Sys.Date() 
FileName <- paste(currentDate,"R01.rda", sep="_") 
...
R01<- R01[which(R01$redcap_event_name!="visit_a2_arm_1"&R01$redcap_event_name!="visit_b2_arm_1"&R01$redcap_event_name!="visit_c2_arm_1"&R01$redcap_event_name!="visit_d2_arm_1"&R01$redcap_event_name!="visit_c2_arm_1"&R01$redcap_event_name!="visit_u24_arm_1"&R01$redcap_event_name!="visit_u24_fu_arm_1"), ] #removed 3105 obs
#---------------------------------------------------
...
AIC<-R01[which(substr(R01$person_id, 2, 2)=="F"),] #has 50702 obs
save(AIC, file=paste(currentDate,"AIC.rda", sep="_"))
